...
export default function Home() {
  return (
    ...
    <main>
      <section>
      <img className="img" src="/assets/images/omelette.jpeg" alt="pic of omlete" />
      
      </section>
      <section>
        <h1 className={young_serif.className}>Simple Omelette Recipe</h1>
        <p className="sub-head">An easy and quick dish, perfect for any meal. This classic omelette combines beaten eggs cooked 
  to perfection, optionally filled with your choice of cheese, vegetables, or meats.
      ...
      <section>
        <h2 className={young_serif.className}>Ingredients</h2>
        <ul>
      ...
      <section className="instructions">
        <h2 className={young_serif.className}>Instructions</h2>
        <ol>
      ...
      <section>
        <h2 className={young_serif.className}>Nutrition</h2>
        <p className="nutrition-p">The table below shows nutritional values per serving without the additional fillings.</p>
        <table>
          <tbody>
          <tr>
            <td>Calories</td>
